...
>**NOTICE:** This README file is provided by the project authors[^1] for informational purposes only and does not grant any additional rights or permissions beyond those specified by `the dataset's original licensing terms`[^2].
...
> For comprehensive information about the `corona-virus-covid19-us-counties`[^3][^4] dataset, please visit the original source or provider via [Kaggle](https://www.kaggle.com/datasets/yasirabdaali/corona-virus-covid19-us-counties)[^4].
...
[^2]: The Public Domain license allows creators to waive all rights to their works, making them freely available for any purpose, including commercial use, without restrictions.
