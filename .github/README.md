...
For comprehensive information about the [Corona Virus Covid-19 US Counties][Dataset url],
...
[^2]: [Yasir Raza](https://www.kaggle.com/yasirabdaali), an expert on [Kaggle][Kaggle], is the original dataset creator.
